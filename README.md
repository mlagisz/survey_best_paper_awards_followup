# Prodding Best Paper Awards Towards Transparency and Incentivising Open Science.   

**Our mission statement:** *Making “best paper” awards more transparent, inclusive, and aligned with Open Science values across disciplines.* 🌟  
...
## 💛 Contributing  
- We welcome researchers with all backgrounds and walks of life to contribute to any Stage of this project.     
- You do not need any special research skills - just attention to detail, Internet access and some time available.   
- Fill in the Expression Of Interest (EOI) form [here](https://forms.gle/DVQAYqQSYjoM3TyQ8).    
...
### Stage 1: Team building and protocol introduction   
- Gathering a team using an EOI form.  
- Introducing the team to the preregistered protocol and assigning tasks.
...
- Preprint in BioRxiv or MetaArxiv.    
...
## 💻 Data and code files      
Final data and code files will be publicly available once the project is completed.   
